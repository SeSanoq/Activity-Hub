<nav x-data="{ open: false }" class="bg-blue-600 text-white border-b">
  ...
  <!-- Navigation Links -->
                <div class="hidden sm:flex items-center space-x-6 ml-10">
                    ...
                    @if(auth()->user()->role === 'staff')
                        ...
                        <x-nav-link :href="url('/my-created-activities')" class="text-white">
                            My Club
                        </x-nav-link>
                    @endif
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center px-3 py-2 text-sm font-medium text-white">
